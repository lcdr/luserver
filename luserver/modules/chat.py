...
class ChatHandling(ServerModule):
	def __init__(self, server):
		...
		cmds = AddItemCommand, AddMissionCommand, BuildCommand, CheckForLeaksCommand, CompleteMissionCommand, DanceCommand, DismountCommand, EverlastingCommand, ExtendInventoryCommand, EyebrowsCommand, EyesCommand, FactionCommand, FilelogCommand, GlowCommand, HairColorCommand, HairStyleCommand, HelpCommand, HighStatsCommand, JetpackCommand, LevelCommand, LocationCommand, LogCommand, MouthCommand, NoConsoleLogCommand, RefillStatsCommand, RemoveMissionCommand, RestartCommand, SendCommand, SetFlagCommand, SpawnCommand, SpawnPhantomCommand, StyleCommand, TeleportCommand, VendorCommand, WhisperCommand, WorldCommand
