...
class CharActivity:
	def request_activity_summary_leaderboard_data(self, game_id:c_int=0, query_type:c_int=1, results_end:c_int=10, results_start:c_int=0, target:c_int64=E, weekly:bool=E):
		leaderboard = LDF()
	...
	def match_request(self, activator:c_int64=E, player_choices:LDF=E, type:c_int=E, value:c_int=E):
	...
	@single
	def match_response(self, response:c_int=E):
		pass

	@single
	def match_update(self, data:LDF=E, type:c_int=E):
		pass
