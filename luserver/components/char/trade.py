...
from ...bitstream import c_bit, c_int64, c_uint, c_uint64
...
class CharTrade:
	...
	@single
	def server_trade_invite(self, need_invite_pop_up:c_bit=False, requestor:c_int64=None, name:str=None):
		pass

	@single
	def server_trade_initial_reply(self, invitee:c_int64=None, result_type:c_uint=None, name:str=None):
		pass
