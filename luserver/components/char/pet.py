...
class CharPet:
	...
	@broadcast
	def notify_pet_taming_puzzle_selected(self, bricks:Sequence[c_uint, c_uint]=E):
		pass

	def pet_taming_try_build(self, selections:Sequence[c_uint, c_uint64]=E, client_failed:bool=False):
