...
class CharCamera:
	...
	def set_ghost_reference_position(self, position:Vector3=E):
		pass

	@single
	def add_camera_effect(self, config:LDF=E, duration:float=-1, effect_id:str=E, effect_type:str=E):
		pass
	...
	@broadcast
	def force_camera_target_cycle(self, force_cycling:bool=False, cycling_mode:c_uint=CyclingMode.AllowCycleTeammates, optional_target:GameObject=E):
		pass
