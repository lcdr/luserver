...
class CharCamera:
	...
	def cinematic_update(self, event:c_uint=CinematicEvent.Started, overall_time:float=-1, path_name:str=ES, path_time:float=-1, waypoint:c_int=-1) -> None:
	...
	def set_ghost_reference_position(self, position:Vector3=EV) -> None:
		pass
