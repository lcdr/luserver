...
from ...game_object import broadcast, c_int_, c_uint_, GameObject, single
from ...ldf import LDF
...
class CharCamera:
	...
	def cinematic_update(self, event:c_uint_=CinematicEvent.Started, overall_time:float=-1, path_name:str=None, path_time:float=-1, waypoint:c_int_=-1):
	...
	@broadcast
	def force_camera_target_cycle(self, force_cycling:bool=False, cycling_mode:c_uint_=CyclingMode.AllowCycleTeammates, optional_target:GameObject=None):
		pass
