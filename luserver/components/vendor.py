...
from ..game_object import c_int, c_int64, E, Mapping, single
...
class VendorComponent(Component):
	...
	def buy_from_vendor(self, player, confirmed:bool=False, count:c_int=1, item:c_int=E):
	...
	def sell_to_vendor(self, player, count:c_int=1, item_obj_id:c_int64=E):
		found = False
