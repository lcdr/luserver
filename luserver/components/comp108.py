...
class Comp108Component(Component):
	...
	def request_die(self, unknown_bool:bool=E, death_type:str=E, direction_relative_angle_xz:float=E, direction_relative_angle_y:float=E, direction_relative_force:float=E, kill_type:c_int=0, killer:GameObject=E, loot_owner:Player=E):
