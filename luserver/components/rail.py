...
class RailActivatorComponent(Component):
	...
	def on_use(self, player, multi_interact_id):
		...
		player.char.start_rail_movement(path_go_forward=self.rail_path_start == 0, loop_sound="", path_name=self.rail_path, path_start=self.rail_path_start, rail_activator_component_id=6, rail_activator_obj_id=self.object.object_id, start_sound="", stop_sound="")
