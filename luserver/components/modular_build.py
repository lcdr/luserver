...
from ..game_object import c_int, c_int64, E, Sequence
...
class ModularBuildComponent(Component):
	...
	def start_building_with_item(self, player, first_time:bool=True, success:bool=E, source_bag:c_int=E, source_id:c_int64=E, source_lot:c_int=E, source_type:c_int=E, target_id:c_int64=E, target_lot:c_int=E, target_pos:Vector3=E, target_type:c_int=E):
	...
	def done_arranging_with_item(self, player, new_source_bag:c_int=E, new_source_id:c_int64=E, new_source_lot:c_int=E, new_source_type:c_int=E, new_target_id:c_int64=E, new_target_lot:c_int=E, new_target_type:c_int=E, new_target_pos:Vector3=E, old_item_bag:c_int=E, old_item_id:c_int64=E, old_item_lot:c_int=E, old_item_type:c_int=E):
	...
	def modular_build_move_and_equip(self, player, template_id:c_int=E):
	...
	def modular_build_convert_model(self, player, model_id:c_int64=E):
