...
class ModularBuildComponent(Component):
	...
	def start_building_with_item(self, player: Player, first_time:bool=True, success:bool=EB, source_bag:c_int=EI, source_id:c_int64=EI, source_lot:c_int=EI, source_type:c_int=EI, target_id:c_int64=EI, target_lot:c_int=EI, target_pos:Vector3=EV, target_type:c_int=EI) -> None:
	...
	def done_arranging_with_item(self, player: Player, new_source_bag:c_int=EI, new_source_id:c_int64=EI, new_source_lot:c_int=EI, new_source_type:c_int=EI, new_target_id:c_int64=EI, new_target_lot:c_int=EI, new_target_type:c_int=EI, new_target_pos:Vector3=EV, old_item_bag:c_int=EI, old_item_id:c_int64=EI, old_item_lot:c_int=EI, old_item_type:c_int=EI) -> None:
	...
	def modular_build_move_and_equip(self, player: Player, template_id:c_int=EI) -> None:
	...
	def modular_build_convert_model(self, player: Player, model_id:c_int64=EI) -> None:
