...
from ..game_object import c_int_, c_int64_, Sequence
...
class ModularBuildComponent(Component):
	...
	def done_arranging_with_item(self, player, new_source_bag:c_int_=None, new_source_id:c_int64_=None, new_source_lot:c_int_=None, new_source_type:c_int_=None, new_target_id:c_int64_=None, new_target_lot:c_int_=None, new_target_type:c_int_=None, new_target_pos:Vector3=None, old_item_bag:c_int_=None, old_item_id:c_int64_=None, old_item_lot:c_int_=None, old_item_type:c_int_=None):
	...
	def modular_build_move_and_equip(self, player, template_id:c_int_=None):
	...
	def modular_build_convert_model(self, player, model_id:c_int64_=None):
