...
class RenderComponent(Component):
	...
	@broadcast
	def play_f_x_effect(self, effect_id:c_int=-1, effect_type:"wstr"=None, scale:c_float=1, name:"str"=None, priority:c_float=1, secondary:c_int64=0, serialize:c_bit=True):
	...
	@broadcast
	def play_embedded_effect_on_all_clients_near_object(self, effect_name:"wstr"=None, from_object_id:c_int64=None, radius:c_float=None):
		pass
