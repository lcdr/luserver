...
from luserver.game_object import c_int, c_int64, EO, ES, GameObject, single
...
class ScriptComponent(script.ScriptComponent):
	...
	@single
	def fire_event_client_side(self, args:str=ES, obj:GameObject=EO, param1:c_int64=0, param2:c_int=-1, sender:GameObject=EO):
		pass
