...
class ScriptComponent(script.ScriptComponent):
	def on_use(self, player, multi_interact_id):
		player.char.u_i_message_server_to_single_client(str_message_name="pushGameState", args={"state": "bank"})
	...
	def fire_event_server_side(self, args:"wstr"=None, param1:c_int=-1, param2:c_int=-1, param3:c_int=-1, sender_id:c_int64=None):
		if args == "ToggleBank":
			...
			player.char.u_i_message_server_to_single_client(str_message_name="ToggleBank", args={"visible": False})
